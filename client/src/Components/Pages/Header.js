    ...
    <header>
      <nav className="navbar navbar-expand-xl navbar-light bg-transparent">
        <div class="container">
          ...
          <div
            class="collapse navbar-collapse d-none d-xl-block d-none d-xl-block"
            ...
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                ...
                <div class="nav-item--dropdown">
                  <ul>
                    <li>
                      <a href="event-search.html">Events Search list</a>
                    </li>
                    <li>
              ...
              <div class="navbar-mobile__top">
                ...
                <div>
                  ...
                  <button class="navbar-mobile--cross">
                    ...
                    >
                      <path
                        d="M14.5967 4.59668L5.40429 13.7891"
                        stroke="currentColor"
                        stroke-width="1.5"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      />
                      <path
                        d="M5.40332 4.59668L14.5957 13.7891"
                        stroke="currentColor"
                        stroke-width="1.5"
                        stroke-linecap="round"
                        stroke-linejoin="round"
